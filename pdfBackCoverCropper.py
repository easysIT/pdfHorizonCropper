...
for item in os.listdir("./coverOriginal_pdf"):
    ...
    page.cropBox.lowerLeft = (cutPoint + wingPoint, cutPoint)
    page.cropBox.upperRight = (cutPoint + wingPoint + widthPoint, _upperRightY - cutPoint)
    pdf_writer.addPage(page)

    with open(os.path.join(outputDirName, "뒷표지_" + item), "wb") as f:
        pdf_writer.write(f)
